...
class MainWindow(QMainWindow):
    ...
    def on_add(self):
        ...
        # Prepare for next entry: clear description and update default ticket if it was app-suggested
        self.on_clear()
        # If the current ticket matches the app-suggested pattern, advance to next
        if self.ticket_edit.text().startswith("TH"):
            self.fill_default_ticket()
        self.load_table()
